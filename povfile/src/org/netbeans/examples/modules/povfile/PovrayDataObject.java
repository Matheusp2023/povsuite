...
@Messages({
    "LBL_Povray_LOADER=Files of Povray"
})
@MIMEResolver.ExtensionRegistration(
        displayName = "#LBL_Povray_LOADER",
        mimeType = "text/x-povray",
        extension = {"pov", "POV", "inc", "INC"}
)
@DataObject.Registration(
        mimeType = "text/x-povray",
        iconBase = "org/netbeans/examples/modules/povfile/povray_povicon.gif",
        displayName = "#LBL_Povray_LOADER",
        position = 300
)
@ActionReferences({
    @ActionReference(
            path = "Loaders/text/x-povray/Actions",
